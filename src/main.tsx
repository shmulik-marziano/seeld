    ...
    if (this.state.hasError) {
      return (
        <div dir="rtl" style={{ fontFamily: "sans-serif", textAlign: "center", padding: "60px 20px" }}>
          <h1 style={{ color: "#1a1a4b", fontSize: "24px" }}>SEELD</h1>
          ...
          <button onClick={() => window.location.reload()} style={{ marginTop: "20px", padding: "12px 32px", background: "#1a1a4b", color: "white", border: "none", borderRadius: "999px", cursor: "pointer", fontSize: "16px" }}>
            רענן את הדף
          </button>
        </div>
      );
