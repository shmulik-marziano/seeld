...
const DocumentsTab = ({ customerId }: { customerId: string }) => {
  ...
  if (files.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-sm border p-12 text-center">
        ...
        <h3 className="text-lg font-bold mb-2" style={{ color: "#003D30" }}>אין מסמכים עדיין</h3>
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-bold" style={{ color: "#003D30" }}>המסמכים שלי</h2>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-sm truncate" style={{ color: "#003D30" }}>
                  {displayName}
                </p>
              ...
              {file.file_url && (
                <a
                  ...
                  className="shrink-0 p-2 rounded-full hover:bg-gray-100 transition-colors text-[#003D30] hover:text-[#003D30]"
                  title="הורד / צפה"
                >
