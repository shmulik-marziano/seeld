      ...
      >
        <div className="flex items-center gap-4">
          ...
          >
            ...
            {/* Status dot */}
            <div
              className="absolute -bottom-0.5 -left-0.5 w-4 h-4 rounded-full border-2 border-[#fafafa]"
...
const BubbleStatCard = ({
  ...
  <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 text-center hover:shadow-[0_8px_30px_rgba(23,23,23,0.06)] hover:-translate-y-1 transition-all duration-300 group">
...
const BubbleActionCard = ({
  ...
  <div className="bg-white rounded-[24px] p-6 sm:p-7 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100 hover:shadow-[0_12px_40px_rgba(23,23,23,0.08)] hover:-translate-y-1.5 transition-all duration-300 cursor-pointer group relative overflow-hidden">
