...
const benefits = [
  { icon: FileText, text: "צפייה בפוליסות", desc: "כל הביטוחים שלך במקום אחד", color: "#171717" },
  { icon: Heart, text: "המלצות מותאמות", desc: "ניתוח אישי של הכיסוי הביטוחי שלך", color: "#171717" },
  { icon: Wallet, text: "מעקב חיסכון ופנסיה", desc: "נתונים עדכניים על החסכונות שלך", color: "#b45309" },
  { icon: Phone, text: "תקשורת עם הסוכן", desc: "צ'אט ישיר ועדכונים בזמן אמת", color: "#15803d" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row" dir="rtl">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(165deg, #072e2e 0%, #171717 40%, #262626 70%, #171717 100%)",
        }}
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{ background: "radial-gradient(circle, #d4d4d4, transparent 70%)" }}
          />
          ...
          <motion.div
            ...
            className="absolute top-[20%] left-[25%] w-3 h-3 rounded-full bg-[#171717]"
          />
          <motion.div
            animate={{ y: [0, 6, 0], opacity: [0.15, 0.3, 0.15] }}
            transition={{ duration: 8, repeat: Infinity, delay: 2 }}
            className="absolute bottom-[30%] right-[20%] w-2 h-2 rounded-full bg-[#b45309]"
          />
          <motion.div
            animate={{ y: [0, -5, 0], opacity: [0.1, 0.25, 0.1] }}
            transition={{ duration: 7, repeat: Infinity, delay: 4 }}
            className="absolute top-[65%] left-[15%] w-2.5 h-2.5 rounded-full bg-[#15803d]"
          />
          ...
          <svg className="absolute bottom-20 left-0 w-full h-16 opacity-[0.06] pointer-events-none" viewBox="0 0 400 50" fill="none">
            <path d="M0 35 Q100 10 200 30 T400 15" stroke="#171717" strokeWidth="1" strokeDasharray="8 6" />
          </svg>
        </div>
        ...
        >
          ...
          >
            <div
              ...
              style={{ background: "linear-gradient(165deg, #072e2e 0%, #171717 50%, #262626 100%)" }}
            >
              {/* Mobile bubbles */}
            ...
            <AnimatePresence mode="wait">
              ...
              {step === "email" && (
                ...
                >
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium text-[#171717]">כתובת אימייל</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        dir="ltr"
                        className="h-12 sm:h-11 pr-10 rounded-full text-base sm:text-sm border-gray-200 focus-visible:ring-[#171717]/30 text-left"
                      />
                    </div>
                  </div>
                  <Button
                    type="submit"
                    className="w-full h-12 sm:h-11 rounded-full gap-2 font-semibold text-base sm:text-sm min-h-[48px] shadow-lg shadow-[#171717]/20 bg-[#171717] hover:bg-[#262626]"
                    disabled={loading}
                  >
                  ...
                  <button
                    ...
                    className="w-full text-sm text-gray-500 hover:text-[#171717] min-h-[44px] transition-colors"
                  >
              ...
              {step === "otp" && (
                <motion.div
                  ...
                  className="space-y-5"
                >
                  <div className="flex items-center gap-3 bg-[#f5f5f5] border border-[#171717]/10 rounded-xl p-3.5">
                    <CheckCircle2 className="w-5 h-5 text-[#171717] shrink-0" />
                    <p className="text-xs sm:text-sm text-[#171717]/80">
                      שלחנו קוד חד-פעמי ל-<span className="font-semibold text-[#171717]" dir="ltr">{email}</span>
                    </p>
                  </div>

                  <div className="flex flex-col items-center gap-4">
                    <Label className="text-xs font-medium text-[#171717]">קוד חד-פעמי (6 ספרות)</Label>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <button
                      ...
                      className="text-gray-400 hover:text-[#171717] hover:underline min-h-[44px] px-2 transition-colors disabled:opacity-40 disabled:pointer-events-none"
                      disabled={loading}
                    >
                      שלח קוד מחדש
                    </button>
