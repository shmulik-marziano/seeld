...
const RecommendationsTab = ({ customerId }: { customerId: string }) => {
  ...
  if (recommendations.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-sm border p-12 text-center">
        ...
        <h3 className="text-lg font-bold mb-2" style={{ color: "#1a1a4b" }}>אין המלצות עדיין</h3>
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-bold" style={{ color: "#1a1a4b" }}>המלצות הסוכן</h2>
                ...
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap mb-1">
                      <h3 className="font-bold text-base" style={{ color: "#1a1a4b" }}>
                        {rec.title || "המלצה"}
                      </h3>
                      <span
