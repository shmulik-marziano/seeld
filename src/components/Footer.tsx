...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { href: "mailto:info@seeld-ins.co.il", icon: <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>, label: "Email" },
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:pt-4">
              ...
              <div className="space-y-5">
                ...
                <a href="mailto:info@seeld-ins.co.il" className="flex items-center gap-3 text-gray-600 hover:text-[#0a3d3d] transition-colors group">
                  ...
                  <span className="text-base font-medium">info@seeld-ins.co.il</span>
                </a>
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span className="text-base font-medium">ישראל</span>
                </div>
              </div>
