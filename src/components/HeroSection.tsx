        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-8 lg:space-y-10">
            ...
            >
              ...
              <br />
              ליווי מקצועי, שקוף ובגובה העיניים.
            </motion.p>
          ...
          >
            ...
            <div className="relative w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] lg:w-[480px] lg:h-[480px]">
              ...
              {/* Pill/capsule shape - like Autoflow */}
              <motion.div
              ...
              <motion.div
                className="absolute top-[10%] right-[40%] w-4 h-4 rounded-full bg-[#ffc929]"
                animate={{ y: [0, -6, 0] }}
                transition={{ duration: 3, repeat: Infinity }}
              />
              <motion.div
                className="absolute top-[75%] right-[60%] w-3 h-3 rounded-full bg-[#e76f51]/60"
                animate={{ y: [0, 5, 0] }}
                transition={{ duration: 4, repeat: Infinity, delay: 1 }}
              />
              <motion.div
                className="absolute top-[80%] right-[20%] w-3 h-3 rounded-full bg-[#5ec6c6]/50"
                animate={{ scale: [1, 1.4, 1] }}
                transition={{ duration: 3, repeat: Infinity, delay: 0.5 }}
              />

              {/* Small dashed connector between circles */}
