...
import { quickInsuranceMenuData, QuickInsuranceCategory } from "@/data/quickInsuranceMenuData";

interface QuickInsuranceMegaMenuProps {
  onClose: () => void;
}
...
const QuickInsuranceMegaMenu = ({ onClose }: QuickInsuranceMegaMenuProps) => {
  return (
    <div className="absolute top-full right-0 w-[700px] pt-2 z-50">
      ...
      >
        <div className="grid grid-cols-3 gap-8">
          {quickInsuranceMenuData.map((category: QuickInsuranceCategory) => (
...
export default QuickInsuranceMegaMenu;
