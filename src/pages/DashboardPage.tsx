...
function saveLayout(d: LayoutData) {
  try { localStorage.setItem(STORAGE_KEY, JSON.stringify(d)); } catch { /* storage unavailable (private mode / quota) — non-critical */ }
}
  ...
  return (
    <div className="-m-3 sm:-m-4 md:-m-6 relative" style={{ backgroundColor: '#f8f9fc' }} dir="rtl">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden select-none z-0">
        <div className="absolute -top-48 -right-48 w-[560px] h-[560px] rounded-full blur-[100px] opacity-[0.08]" style={{ backgroundColor: '#d6157e' }} />
        <div className="absolute top-[40%] -left-52 w-[420px] h-[420px] rounded-full blur-[100px] opacity-[0.06]" style={{ backgroundColor: '#6b6fc4' }} />
        ...
        <svg className="absolute top-0 right-[2%] w-[500px] h-[650px] opacity-[0.1]" viewBox="0 0 500 600" fill="none">
          <motion.path d="M450,30 C380,50 300,130 320,230 C340,330 220,380 160,450 C130,490 140,540 200,560"
            stroke="#1a1a4b" strokeWidth="2.5" strokeDasharray="10 8" strokeLinecap="round" fill="none"
        ...
        <div className="absolute inset-0 opacity-[0.016]"
          style={{ backgroundImage: 'radial-gradient(circle, #1a1a4b 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 whitespace-nowrap"
          style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontSize: 160, fontWeight: 900,
            color: '#1a1a4b', opacity: 0.018, letterSpacing: '0.3em' }}>SEELD</div>
      </div>
        ...
        <div className="flex-1 min-w-0 px-4 sm:px-5 pt-6 pb-24 overflow-x-hidden">
          ...
          <div className="flex items-center justify-between mb-5">
            <button onClick={() => navigate('/app/dashboard')} className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
              <SeeIDLogo size={30} />
              <div>
                <div className="text-sm font-black text-[#1a1a4b] leading-none"
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <motion.button whileTap={{ scale: 0.9 }} onClick={() => setMenuOpen(v => !v)}
                  ...
                  style={{
                    backgroundColor: editMode || menuOpen ? '#1a1a4b' : 'white',
                    color: editMode || menuOpen ? '#d6157e' : '#94a3b8',
                    border: editMode ? '2px solid #d6157e' : '2px solid #e2e8f0',
                  }}>
                      ...
                      >
                        ...
                        <button onClick={() => { setEditMode(v => !v); setMenuOpen(false); }}
                          ...
                          <div className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0"
                            style={{ backgroundColor: editMode ? '#1a1a4b' : '#f1f5f9' }}>
                            <PenTool className="w-4 h-4" style={{ color: editMode ? '#d6157e' : '#64748b' }} />
                          </div>
                          <div>
            ...
            {editMode && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }}
                ...
                <div className="flex items-center justify-between px-5 py-3 rounded-2xl"
                  style={{ backgroundColor: '#1a1a4b', boxShadow: '0 4px 20px rgba(10,61,61,0.25)' }}>
                  ...
                  <button onClick={() => setEditMode(false)}
                    ...
                    style={{ backgroundColor: '#d6157e', color: '#1a1a4b' }}>
          ...
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="mb-5">
            ...
            <h1 className="text-3xl font-black text-[#1a1a4b] leading-none"
              style={{ fontFamily: "'Plus Jakarta Sans','Heebo',sans-serif" }}>{getGreeting()}</h1>
            <p className="text-xs text-gray-400 mt-1">
              {activeSection
                ? <><span className="text-[#1a1a4b] font-bold">{activeSection}</span>{' · '}{displayBubbles.length} בועות</>
