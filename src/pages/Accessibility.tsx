  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative bg-[#f8f9fc] overflow-hidden">
        <div className="absolute top-6 left-10 w-20 h-20 rounded-full bg-[#f06ba8] opacity-10" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 relative z-10">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[#f06ba8] flex items-center justify-center">
              <AccessibilityIcon className="h-5 w-5 text-white" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-[#1a1a4b]">הצהרת נגישות</h1>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="space-y-8 text-sm leading-relaxed text-gray-700">
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">מחויבות לנגישות</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">תקן הנגישות</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">התאמות הנגישות באתר</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">דרכי פנייה בנושא נגישות</h2>
            <p className="mb-4">
              אם נתקלתם בבעיית נגישות באתר, נשמח לקבל את פנייתכם כדי שנוכל לטפל בנושא:
            </p>
            <div className="bg-[#f8f9fc] rounded-xl p-5 space-y-1">
              <p><strong className="text-[#1a1a4b]">רכז נגישות:</strong> שמוליק מרציאנו</p>
              <p>טלפון: <a href="tel:0523097444" className="text-[#d6157e] hover:underline">052-309-7444</a></p>
              <p>אימייל: <a href="mailto:info@seeld-ins.co.il" className="text-[#d6157e] hover:underline">info@seeld-ins.co.il</a></p>
            </div>
          </section>

          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">תוכנות והתקנים נתמכים</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">עדכון הצהרת הנגישות</h2>
            <p>
