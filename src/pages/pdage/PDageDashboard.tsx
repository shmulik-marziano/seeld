  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto px-4 sm:px-0">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">pDage</h1>
          <p className="text-sm text-muted-foreground">ליקויים וחוסרים — כלי חכם לעריכת מסמכים</p>
        </div>
        <Button onClick={() => navigate('/app/pdage/upload')} size="lg" className="gap-2 w-full sm:w-auto min-h-[44px]">
