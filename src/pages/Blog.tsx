...
const Blog = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950" dir="rtl">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-[#f8f9fc] dark:bg-gray-900 py-20 sm:py-28">
        {/* Decorative circles */}
        <div className="absolute top-10 right-10 w-32 h-32 rounded-full bg-[#5ec6c6] opacity-20" />
        <div className="absolute bottom-10 left-16 w-24 h-24 rounded-full bg-[#f4a261] opacity-20" />
        <div className="absolute top-1/2 left-1/3 w-16 h-16 rounded-full bg-[#90be6d] opacity-15" />
        <div className="absolute bottom-20 right-1/4 w-20 h-20 rounded-full bg-[#e76f51] opacity-15" />

        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#0a3d3d] dark:text-white mb-4">
            הבלוג של SEELD
          </h1>
