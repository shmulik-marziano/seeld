...
const tabTriggerClass =
  "rounded-none bg-transparent px-0 pb-4 text-sm sm:text-base font-medium text-[#1a1a18]/40 border-b-2 border-transparent data-[state=active]:border-[#1a1a18] data-[state=active]:text-[#1a1a18] data-[state=active]:bg-transparent data-[state=active]:shadow-none transition-colors inline-flex items-center gap-2";

const tabHeadClass = "border-t border-[#1a1a18]/20 pt-5 mb-8 text-right";
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8 pt-12 sm:pt-16 pb-12 sm:pb-16">
          ...
          <div className="border-t border-[#1a1a18]/20 pt-5 mb-10 sm:mb-14 flex items-baseline justify-between gap-4">
            <nav className="flex items-center gap-2 text-[12px] text-[#1a1a18]/40">
              ...
              <span>←</span>
              <span className="text-[#1a1a18]/70 font-medium">מחשבונים</span>
            </nav>
        ...
        <section className="bg-white">
          <div className="max-w-5xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
            <Tabs defaultValue="mortgage" dir="rtl">
              <TabsList className="flex w-full flex-wrap justify-start gap-x-8 gap-y-1 h-auto bg-transparent p-0 mb-10 border-b border-[#1a1a18]/10 rounded-none">
                <TabsTrigger value="mortgage" className={tabTriggerClass}>
                  <Home className="w-4 h-4 text-[#1a1a18]/50" strokeWidth={1.5} />
                  משכנתא
                </TabsTrigger>
                <TabsTrigger value="pension" className={tabTriggerClass}>
                  <PiggyBank className="w-4 h-4 text-[#1a1a18]/50" strokeWidth={1.5} />
                  פנסיה
                </TabsTrigger>
                <TabsTrigger value="savings" className={tabTriggerClass}>
                  <Wallet className="w-4 h-4 text-[#1a1a18]/50" strokeWidth={1.5} />
                  חיסכון
                </TabsTrigger>
                <TabsTrigger value="goal" className={tabTriggerClass}>
                  <Target className="w-4 h-4 text-[#1a1a18]/50" strokeWidth={1.5} />
                  יעד
                </TabsTrigger>
                <TabsTrigger value="compare" className={tabTriggerClass}>
                  <BarChart3 className="w-4 h-4 text-[#1a1a18]/50" strokeWidth={1.5} />
                  השוואה
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="mortgage" className="mt-0">
                <div className="text-right">
                  <div className={tabHeadClass}>
                    <h2
                      className="text-[#1a1a18] leading-tight mb-2"
                      style={{ fontFamily: SERIF, fontWeight: 400, fontSize: "clamp(1.5rem, 3vw, 2.1rem)" }}
                    >
                      מחשבון משכנתא
                    </h2>
                    <p className="text-[#1a1a18]/55 text-[14px] leading-[1.85]">חשבו החזר חודשי ועלות כוללת של המשכנתא</p>
                  </div>
                  <MortgageCalculator />
                </div>
              </TabsContent>
              ...
              <TabsContent value="pension" className="mt-0">
                <div className="text-right">
                  <div className={tabHeadClass}>
                    ...
                    <p className="text-[#1a1a18]/55 text-[14px] leading-[1.85]">חשבו כמה תקבלו בפנסיה לפי ההפקדות הנוכחיות</p>
                  </div>
                  <PensionCalculator />
                </div>
              </TabsContent>
              ...
              <TabsContent value="savings" className="mt-0">
                <div className="text-right">
                  <div className={tabHeadClass}>
                    ...
                    <p className="text-[#1a1a18]/55 text-[14px] leading-[1.85]">חשבו כמה תצברו עם ריבית דריבית</p>
                  </div>
                  <SavingsCalculator />
                </div>
              </TabsContent>
              ...
              <TabsContent value="goal" className="mt-0">
                <div className="text-right">
                  <div className={tabHeadClass}>
                    ...
                    <p className="text-[#1a1a18]/55 text-[14px] leading-[1.85]">כמה להפקיד כדי להגיע ליעד הפנסיוני שלכם?</p>
                  </div>
                  <GoalCalculator />
                </div>
              </TabsContent>
              ...
              <TabsContent value="compare" className="mt-0">
                <div className="text-right">
                  <div className={tabHeadClass}>
                    ...
                    <p className="text-[#1a1a18]/55 text-[14px] leading-[1.85]">ראו איך הכסף שלכם גדל בכל מסלול</p>
                  </div>
                  <CompareCalculator />
                </div>
              </TabsContent>
          ...
          <div className="max-w-5xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
            ...
            <div className="grid md:grid-cols-2 gap-x-16">
              {comingSoon.map((calc) => (
                <div
                  key={calc.title}
                  className="flex items-baseline justify-between gap-6 py-[14px] border-b border-[#1a1a18]/10"
                >
                  <div className="min-w-0">
                    <div className="flex items-center gap-2.5 mb-1">
                      <calc.icon className="w-4 h-4 text-[#1a1a18]/50 shrink-0" strokeWidth={1.5} />
                      <h3 className="text-[15px] font-medium text-[#1a1a18]">{calc.title}</h3>
                    </div>
                    <p className="text-[13px] text-[#1a1a18]/40 leading-relaxed">{calc.description}</p>
                  </div>
