...
const Growth = () => {
  ...
  const pillars = [
    ...
    { title: "השקעות", description: "מסלולי השקעה מגוונים להגדלת ההון שלכם" },
    { title: "תכנון מס", description: "ניצול מרבי של הטבות מס וחיסכון בתשלומים" },
    { title: "יעדים פיננסיים", description: "הגדרת יעדים וליווי מקצועי לאורך כל הדרך" },
  ];
              ...
              {pillars.map((pillar, i) => (
                <ScrollReveal key={pillar.title} delay={i * 60}>
                  <div className="border-t border-[#171717]/15 pt-5 h-full">
                    ...
                    <p className="text-[14px] text-[#171717]/50 leading-[1.8]">{pillar.description}</p>
                  </div>
                </ScrollReveal>
              ))}
            </div>
