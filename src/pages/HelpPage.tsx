  ...
  return (
    <div className="border border-gray-100 rounded-2xl overflow-hidden bg-white hover:shadow-sm transition-shadow">
      <button onClick={onToggle}
        ...
        <div className="w-9 h-9 rounded-full bg-[#171717]/5 flex items-center justify-center flex-shrink-0">
          <Icon className="w-4 h-4 text-[#171717]" />
        </div>
        <span className="flex-1 text-sm font-extrabold text-[#171717]">{item.q}</span>
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto" dir="rtl">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="w-12 h-12 rounded-full bg-[#171717] flex items-center justify-center shadow-lg">
          <HelpCircle className="h-5 w-5 text-white" />
        </div>
        <div>
          <h1 className="text-2xl font-extrabold text-[#171717]">מרכז עזרה</h1>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="absolute top-0 left-0 w-40 h-40 rounded-full bg-[#171717]/10 -translate-x-1/2 -translate-y-1/2" />
      ...
      {FAQ_SECTIONS.map((section, si) => (
        <motion.div key={section.title} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-extrabold text-[#171717]">{section.title}</h3>
          </div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
        ...
        <h3 className="text-lg font-extrabold text-[#171717] mb-5">צריכים עזרה נוספת?</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <a href="mailto:support@seeld.ai"
            className="flex items-center gap-3 p-4 rounded-2xl border border-gray-100 hover:border-[#171717] hover:shadow-md transition-all group">
            <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center group-hover:bg-[#171717]/10 transition-colors">
              <Mail className="w-5 h-5 text-blue-500 group-hover:text-[#171717] transition-colors" />
            </div>
            <div>
              <p className="text-sm font-extrabold text-[#171717]">מייל</p>
              <p className="text-xs text-gray-400">support@seeld.ai</p>
            </div>
          </a>
          <a href="tel:052-3097444"
            className="flex items-center gap-3 p-4 rounded-2xl border border-gray-100 hover:border-[#171717] hover:shadow-md transition-all group">
            <div className="w-10 h-10 rounded-full bg-green-50 flex items-center justify-center group-hover:bg-[#171717]/10 transition-colors">
              <Phone className="w-5 h-5 text-green-500 group-hover:text-[#171717] transition-colors" />
            </div>
            <div>
              <p className="text-sm font-extrabold text-[#171717]">טלפון</p>
          ...
          <a href="https://wa.me/972523097444" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-3 p-4 rounded-2xl border border-gray-100 hover:border-[#171717] hover:shadow-md transition-all group">
            <div className="w-10 h-10 rounded-full bg-[#25D366]/10 flex items-center justify-center group-hover:bg-[#171717]/10 transition-colors">
              <MessageCircle className="w-5 h-5 text-[#25D366] group-hover:text-[#171717] transition-colors" />
            </div>
            <div>
              <p className="text-sm font-extrabold text-[#171717]">WhatsApp</p>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}
        ...
        style={{ borderColor: '#17171720', backgroundColor: '#17171705' }}>
