...
const ForeignWorkersInsurance = () => {
  return (
    <InsurancePageTemplate
      ...
      heroDescription="ביטוח בריאות לעובדים זרים ותיירים בישראל, כנדרש בחוק."
      ...
      articles={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "ב-SEELD אנחנו מתמחים בהתאמת ביטוח עובדים זרים למעסיקים מכל הסוגים, ממשפחות המעסיקות מטפלות סיעודיות ועד חברות עם עשרות עובדים. נמצא לכם פוליסה שעומדת בדרישות החוק, בלי לשלם יותר מהנדרש.",
          ],
        },
      ]}
      faqItems={[
