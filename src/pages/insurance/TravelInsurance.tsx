  ...
  const quickPurchaseBanner = (
    <section className="py-10 sm:py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="rounded-2xl bg-[#171717] p-8 sm:p-12 text-center space-y-6">
      ...
      articles={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "ב-SEELD אנחנו משווים עבורכם בין כל חברות הביטוח בשוק ומוצאים פוליסה שמתאימה ליעד, למשך הנסיעה ולצרכים שלכם.",
          ],
        },
      ]}
      faqItems={[
