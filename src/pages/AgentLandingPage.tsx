    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative min-h-[90vh] sm:min-h-[100vh] flex items-center overflow-hidden bg-[#fafafa]">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 py-16 sm:py-24 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="space-y-8 lg:space-y-10">
              ...
              >
                ...
                <span className="relative inline-block">
                  ...
                  <motion.span
                    className="absolute -bottom-2 left-0 right-0 h-[5px] bg-[#171717] rounded-full"
              ...
              >
                <Link to="/app/auth">
                  <Button className="bg-[#171717] text-white hover:bg-[#262626] rounded-full px-10 py-5 text-base font-bold shadow-xl shadow-[#171717]/10 min-h-[56px]">
                    התחל בחינם
                    <ArrowLeft className="w-5 h-5 mr-2" />
                  </Button>
                </Link>
                <Link to="/app/auth">
                  <Button variant="outline" className="border-[#171717]/15 text-[#171717] hover:bg-[#171717]/5 rounded-full px-10 py-5 text-base font-semibold min-h-[56px]">
                    כניסה למערכת
                  </Button>
                </Link>
              </motion.div>
            ...
            <motion.div className="hidden sm:flex relative items-center justify-center lg:justify-start"
              ...
              <div className="relative w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] lg:w-[480px] lg:h-[480px]">
                ...
                <motion.div className="absolute top-[55%] right-[15%] w-[200px] sm:w-[280px] h-[60px] sm:h-[75px] rounded-full border-2 border-[#171717]/15 flex items-center px-4"
                ...
                <motion.div className="absolute top-[10%] right-[40%] w-4 h-4 rounded-full bg-[#d4d4d4]" animate={{ y: [0,-6,0] }} transition={{ duration: 3, repeat: Infinity }} />
                <motion.div className="absolute top-[75%] right-[60%] w-3 h-3 rounded-full bg-[#171717]/30" animate={{ y: [0,5,0] }} transition={{ duration: 4, repeat: Infinity, delay: 1 }} />
                <motion.div className="absolute top-[80%] right-[20%] w-3 h-3 rounded-full bg-[#171717]/50" animate={{ scale: [1,1.4,1] }} transition={{ duration: 3, repeat: Infinity, delay: 0.5 }} />
          ...
          {/* Trust bar */}
          <motion.div className="mt-16 sm:mt-24 pt-8 border-t border-[#171717]/[0.06]"
      ...
      <section className="py-14 sm:py-24 bg-white relative">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <motion.div className="text-center mb-12 sm:mb-16"
            ...
            <span className="inline-block px-4 py-1.5 rounded-full bg-[#171717]/5 text-[#171717] text-sm font-bold mb-4">
              מוכר לך?
            </span>
          ...
          <motion.div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-6"
            ...
            {[
              ...
              <motion.div key={i} variants={fadeUp}
                ...
                className="bg-[#fafafa] border border-[#171717]/[0.06] rounded-2xl p-6 sm:p-8 hover:shadow-xl hover:shadow-[#171717]/[0.04] transition-all duration-300 relative overflow-hidden">
      ...
      <section className="py-14 sm:py-24 bg-[#fafafa] relative overflow-hidden">
        <motion.div animate={{ y: [0,-12,0] }} transition={{ duration: 7, repeat: Infinity }}
          className="absolute top-10 left-[6%] w-[50px] h-[50px] sm:w-[70px] sm:h-[70px] rounded-full bg-[#171717] opacity-[0.05]" />
        <motion.div animate={{ y: [0,10,0] }} transition={{ duration: 6, repeat: Infinity, delay: 1 }}
          className="absolute bottom-16 right-[10%] w-[35px] h-[35px] sm:w-[45px] sm:h-[45px] rounded-full bg-[#171717] opacity-[0.05]" />

        <div className="max-w-3xl mx-auto px-5 sm:px-8 text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-[#171717] mb-10 sm:mb-14">
              מה אם היה <span className="text-[#171717]">מקום אחד שמכסה הכל?</span>
            </h2>
            <div className="bg-white border border-[#171717]/[0.06] rounded-2xl p-8 sm:p-12 text-right shadow-sm relative overflow-hidden">
              <div className="absolute top-0 right-0 w-full h-1.5 rounded-b-full bg-[#171717]" />
              <p className="text-base sm:text-xl text-[#171717]/65 leading-relaxed font-medium">
                ...
                <br />
                <span className="text-[#171717] font-bold">זה לא חלום. זה SEELD.</span>
              </p>
            </div>
            <div className="mt-10">
              <Link to="/app/auth">
      ...
      <section className="py-14 sm:py-24 bg-white relative">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          <motion.div className="text-center mb-12 sm:mb-16"
            initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <span className="inline-block px-4 py-1.5 rounded-full bg-[#171717]/[0.06] text-[#171717] text-sm font-bold mb-4">
              הפלטפורמה
            </span>
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-[#171717] mb-3">
      ...
      <section className="py-14 sm:py-24 bg-[#fafafa] relative overflow-hidden">
        <motion.div animate={{ y: [0,-12,0] }} transition={{ duration: 7, repeat: Infinity }}
          className="absolute top-10 right-[6%] w-[50px] h-[50px] sm:w-[65px] sm:h-[65px] rounded-full bg-[#171717] opacity-[0.05]" />
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8">
          <motion.h2 className="text-2xl sm:text-4xl font-extrabold text-[#171717] mb-16 text-center"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-10">
            {[
              ...
              { display: null, suffix: "%", label: "חיסכון בזמן עבודה ידנית",  color: "#171717", delay: 0.1, isCount: true },
              { display: "אפס", suffix: "",   label: "הקלדה ידנית כפולה",         color: "#171717", delay: 0.2 },
              { display: "24/7", suffix: "",  label: "עובדת גם כשאתה לא",         color: "#171717", delay: 0.3 },
            ].map((item, i) => (
      ...
      <section className="py-14 sm:py-24 bg-white">
        <div className="max-w-5xl mx-auto px-5 sm:px-8">
          <motion.div
            className="bg-[#171717] rounded-3xl p-8 sm:p-14 text-center text-white relative overflow-hidden"
            initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <motion.div animate={{ y: [0,-10,0] }} transition={{ duration: 6, repeat: Infinity }}
              className="absolute top-[-40px] right-[-40px] w-[100px] h-[100px] sm:w-[130px] sm:h-[130px] rounded-full bg-[#171717] opacity-[0.05]" />
