      ...
      <main>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10">
          ...
          <div className="mb-12 animate-slide-up">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-sm text-muted-foreground">{article.readTime} קריאה</span>
            </div>
          ...
          <div className="prose prose-lg max-w-none mb-16 animate-slide-up stagger-2">
            ...
            <div className="mt-12 p-6 rounded-2xl bg-muted border-r-4 border-accent">
          ...
          <div className="md:hidden mb-12 pb-12 border-b border-border">
            <p className="text-sm font-semibold mb-4">שתפו את המאמר</p>
          ...
          <div className="mb-16 rounded-2xl bg-card p-8 md:p-12 text-center">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">נהניתם מהמאמר?</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-full border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring text-right"
              />
        ...
        <section className="bg-muted py-16 animate-fade-in">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-8 animate-slide-up">אולי יעניין אתכם גם</h2>
