      ...
      return (
        <div dir="rtl" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f0f2f5', padding: 20 }}>
          <div style={{ background: 'white', borderRadius: 24, padding: 32, maxWidth: 500, textAlign: 'center', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
            <h2 style={{ color: '#3b3f99', fontSize: 20, fontWeight: 800, marginBottom: 8 }}>שגיאה בטעינת מנהל האתר</h2>
            <p style={{ color: '#666', fontSize: 14, marginBottom: 16 }}>{this.state.error.message}</p>
            <button onClick={() => { this.setState({ error: null }); window.location.reload(); }}
              style={{ background: '#1a1a4b', color: 'white', border: 'none', padding: '10px 24px', borderRadius: 50, cursor: 'pointer', fontWeight: 700 }}>
              נסה שוב
            </button>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f0f2f5] px-4" dir="rtl">
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 max-w-sm text-center">
          <div className="w-16 h-16 rounded-full bg-[#3b3f99]/10 flex items-center justify-center mx-auto mb-4">
            <Shield className="w-8 h-8 text-[#3b3f99]" />
          </div>
          <h2 className="text-xl font-bold text-[#1a1a4b] mb-2">אין הרשאה</h2>
  ...
  if (step === "login" || step === "otp" || step === "magic-sent") {
    return (
      ...
      >
        ...
        <div className="absolute bottom-[15%] right-[10%] w-[60px] h-[60px] rounded-full opacity-20 pointer-events-none bg-[#6b6fc4]" />
        <div className="absolute bottom-[25%] right-[25%] w-[30px] h-[30px] rounded-full opacity-15 pointer-events-none bg-[#d6157e]" />
        <div className="absolute top-[5%] right-[40%] w-3 h-3 rounded-full bg-[#6b6fc4] opacity-60 pointer-events-none" />
        ...
        >
          <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-8 space-y-6">
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                <h1 className="text-2xl font-extrabold text-[#1a1a4b]">ניהול האתר</h1>
            ...
            <AnimatePresence mode="wait">
                  ...
                  <div className="space-y-3">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="h-12 pr-11 rounded-full text-sm border-gray-200 focus-visible:ring-[#d6157e]/40 text-right"
                      />
                    </div>
                    ...
                    <Button
                      ...
                      className="w-full h-12 rounded-full gap-2 text-sm font-semibold bg-[#1a1a4b] hover:bg-[#2a2a66] shadow-lg shadow-[#1a1a4b]/15"
                    >
                  ...
                  <form onSubmit={handleSendOtp} className="space-y-3">
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        dir="ltr"
                        className="h-12 pr-11 rounded-full text-sm border-gray-200 focus-visible:ring-[#d6157e]/40 text-left"
                      />
                    </div>
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="flex-1 h-11 rounded-full gap-2 text-sm font-semibold bg-[#1a1a4b] hover:bg-[#2a2a66] shadow-lg shadow-[#1a1a4b]/15"
                        disabled={loading}
                      >
              ...
              {step === "magic-sent" && (
                ...
                >
                  <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center" style={{ background: "#d6157e20" }}>
                    <Mail className="w-7 h-7 text-[#d6157e]" />
                  </div>
                  <div>
                    <h3 className="font-bold text-[#1a1a4b] text-lg mb-1">בדוק את המייל</h3>
                    <p className="text-sm text-gray-500">
                      שלחנו לינק כניסה ל-<span className="font-semibold text-[#1a1a4b]" dir="ltr">{email}</span>
                    </p>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <button
                      ...
                      className="text-sm text-gray-400 hover:text-[#1a1a4b] py-2 transition-colors"
                    >
              ...
              {step === "otp" && (
                <motion.div
                  ...
                  className="space-y-5"
                >
                  <div className="bg-[#d6157e]/10 rounded-2xl p-3.5 flex items-center gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#d6157e] shrink-0" />
                    <p className="text-xs text-[#1a1a4b]/80">
                      קוד נשלח ל-<span className="font-semibold text-[#1a1a4b]" dir="ltr">{email}</span>
                    </p>
                  </div>
                  ...
                  <div className="flex justify-center gap-2.5" dir="ltr">
                    {[0, 1, 2, 3, 4, 5].map((i) => (
                      <input
                        ...
                        className={cn(
                          "w-12 h-12 rounded-full border-2 text-center text-lg font-bold text-[#1a1a4b] outline-none transition-all",
                          otp[i]
                            ? "border-[#d6157e] bg-[#d6157e]/5 shadow-sm"
                            : "border-gray-200 bg-white hover:border-gray-300",
                          "focus:border-[#d6157e] focus:ring-2 focus:ring-[#d6157e]/20"
                        )}
                      />
                    ))}
                  </div>
                  ...
                  <Button
                    ...
                    className="w-full h-12 rounded-full font-semibold bg-[#1a1a4b] hover:bg-[#2a2a66] shadow-lg shadow-[#1a1a4b]/15"
                  ...
                  <div className="flex items-center justify-between">
                    <button
                      type="button"
                      onClick={() => { setStep("login"); setOtp(""); }}
                      className="text-sm text-gray-400 hover:text-[#1a1a4b] transition-colors"
                    >
                      חזרה
                    </button>
                    <button
                      ...
                      className={cn(
                        ...
                        resendTimer > 0 ? "text-gray-300" : "text-[#d6157e] hover:text-[#1a1a4b]"
                      )}
                    >
      ...
      <main className="flex-1 min-w-0">
        ...
        <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b px-4 sm:px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-[#1a1a4b]">
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 border-b flex items-center gap-3">
        ...
        <div>
          <p className="font-bold text-sm text-[#1a1a4b]">SEELD Admin</p>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "bg-[#1a1a4b] text-white shadow-md shadow-[#1a1a4b]/15"
  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border hover:shadow-md transition-shadow">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-2xl font-extrabold text-[#1a1a4b]">{value}</p>
...
function ModuleHeader({ title, subtitle, action }: {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
      <div>
        <h2 className="text-xl font-bold text-[#1a1a4b]">{title}</h2>
...
function Sparkline({ data, color = "#d6157e", width = 80, height = 28 }: { data: number[]; color?: string; width?: number; height?: number }) {
...
function AnalyticsModule() {
  ...
  const DEVICE_COLORS: Record<string, string> = { desktop: "#1a1a4b", mobile: "#d6157e", tablet: "#6b6fc4" };
  const DEVICE_LABELS: Record<string, string> = { desktop: "\u05DE\u05D7\u05E9\u05D1", mobile: "\u05E0\u05D9\u05D9\u05D3", tablet: "\u05D8\u05D0\u05D1\u05DC\u05D8" };
  const BROWSER_COLORS: Record<string, string> = { Chrome: "#1a1a4b", Safari: "#d6157e", Firefox: "#6b6fc4", Edge: "#f06ba8", Other: "#3b3f99" };
    ...
    <div className="space-y-6">
              ...
              {(["today", "week", "month", "all"] as const).map((r) => (
                <button
                  ...
                  className={cn(
                    ...
                    range === r ? "bg-[#1a1a4b] text-white" : "text-gray-500 hover:text-[#1a1a4b]"
                  )}
                >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-extrabold text-[#1a1a4b]">{loading ? "..." : totalViews.toLocaleString()}</p>
          <div className="mt-3">
            <Sparkline data={sparkViews} color="#d6157e" />
          </div>
        </div>
        {/* Unique Visitors */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-extrabold text-[#1a1a4b]">{loading ? "..." : uniqueSessions.toLocaleString()}</p>
          <div className="mt-3">
            <Sparkline data={sparkSessions} color="#6b6fc4" />
          </div>
        </div>
        {/* Bounce Rate */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-extrabold text-[#1a1a4b]">{loading ? "..." : `${bounceRate}%`}</p>
          <div className="mt-3">
            <Sparkline data={[0, 0, 0, 0, 0, 0, 0].map(() => bounceRate)} color="#3b3f99" />
          </div>
        </div>
        {/* Avg Pages / Session */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-extrabold text-[#1a1a4b]">{loading ? "..." : avgPages}</p>
          <div className="mt-3">
            <Sparkline data={[0, 0, 0, 0, 0, 0, 0].map(() => avgPages)} color="#f06ba8" />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
              <BarChart3 className="w-4 h-4 text-[#d6157e]" />
              {"\u05E6\u05E4\u05D9\u05D5\u05EA \u05DC\u05D0\u05D5\u05E8\u05DA \u05D6\u05DE\u05DF"}
            </h3>
            {loading ? (
              <div className="flex justify-center py-8"><Loader2 className="w-5 h-5 animate-spin text-[#1a1a4b]" /></div>
                      ...
                      <div key={day} className="flex-1 flex flex-col items-center group relative">
                        <div
                          ...
                          style={{
                            ...
                            background: "linear-gradient(180deg, #d6157e, #1a1a4b)",
                            minHeight: 3,
                          }}
                        />
                        <span className="absolute -top-6 text-[10px] font-bold text-[#1a1a4b] bg-white px-1.5 py-0.5 rounded shadow-sm opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                          {count}
                        </span>
                      </div>
                    );
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-[#d6157e]" />
              {"\u05E2\u05DE\u05D5\u05D3\u05D9\u05DD \u05DE\u05D5\u05D1\u05D9\u05DC\u05D9\u05DD"}
            </h3>
            {loading ? (
              <div className="flex justify-center py-8"><Loader2 className="w-5 h-5 animate-spin text-[#1a1a4b]" /></div>
                  ...
                  return (
                    <div key={slug} className="group">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm text-[#1a1a4b] font-medium truncate flex items-center gap-2">
                          <FileText className="w-3.5 h-3.5 text-[#d6157e] shrink-0" />
                          {label(slug)}
                        </span>
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] text-gray-400">{pct}%</span>
                          <span className="text-xs font-bold text-[#1a1a4b] min-w-[32px] text-left" dir="ltr">{count}</span>
                        </div>
                      </div>
                      <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${pct}%`,
                            background: "linear-gradient(90deg, #d6157e, #1a1a4b)",
                          }}
                        />
                      </div>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
              <Globe className="w-4 h-4 text-[#d6157e]" />
              {"\u05DE\u05D3\u05D9\u05E0\u05D5\u05EA"}
            </h3>
              ...
              <div className="space-y-2.5">
                {topCountries.map(([code, count]) => (
                  <div key={code} className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-[#1a1a4b] min-w-[28px] text-left" dir="ltr">{count}</span>
                  </div>
                ))}
              </div>
            )}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
              <MapPin className="w-4 h-4 text-[#6b6fc4]" />
              {"\u05DE\u05DB\u05E9\u05D9\u05E8\u05D9\u05DD"}
            </h3>
            ...
            <div className="flex items-center gap-4 justify-center flex-wrap">
              {(["desktop", "mobile", "tablet"] as const).map((d) => (
                <div key={d} className="flex items-center gap-1.5 text-xs text-gray-500">
                  ...
                  <span className="font-bold text-[#1a1a4b]">{deviceCounts[d]}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
              <Globe className="w-4 h-4 text-[#f06ba8]" />
              {"\u05D3\u05E4\u05D3\u05E4\u05E0\u05D9\u05DD"}
            </h3>
            {/* Stacked horizontal bar */}
            <div className="h-8 rounded-full overflow-hidden flex mb-3">
            ...
            <div className="flex items-center gap-4 justify-center flex-wrap">
              {topBrowsers.map(([name, count]) => (
                <div key={name} className="flex items-center gap-1.5 text-xs text-gray-500">
                  ...
                  <span>{name}</span>
                  <span className="font-bold text-[#1a1a4b]">{count}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
              <Link2 className="w-4 h-4 text-[#3b3f99]" />
              {"\u05DE\u05E7\u05D5\u05E8\u05D5\u05EA \u05EA\u05E0\u05D5\u05E2\u05D4"}
            </h3>
              ...
              <div className="space-y-2">
                {topReferrers.map(([domain, count]) => (
                  <div key={domain} className="flex items-center justify-between py-1.5 px-2 rounded-lg hover:bg-gray-50">
                    <span className="text-sm text-[#1a1a4b] truncate max-w-[200px]" dir="ltr">{domain}</span>
                    <span className="text-xs font-bold text-[#1a1a4b]">{count}</span>
                  </div>
                ))}
              </div>
            )}
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <h3 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
          <Clock className="w-4 h-4 text-[#d6157e]" />
          {"\u05E4\u05E2\u05D9\u05DC\u05D5\u05EA \u05D0\u05D7\u05E8\u05D5\u05E0\u05D4"}
            ...
            {views.slice(0, 50).map((v, i) => {
              ...
              return (
                <div key={i} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-50 text-sm transition-colors">
                  ...
                  <span className="font-medium text-[#1a1a4b] truncate flex-1">{label(v.slug)}</span>
  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border hover:shadow-md transition-all">
      <div
        ...
        style={{ background: "linear-gradient(135deg, #f06ba8 0%, #6fa34d 100%)" }}
      >
        <RefreshCw className={cn("w-6 h-6 text-white", syncing && "animate-spin")} />
      </div>
      <h4 className="font-bold text-[#1a1a4b] mb-0.5">סנכרן מסלולי השקעה</h4>
      <p className="text-xs text-gray-400 mb-3">העלה קובץ Excel מגמלנט/פנסיהנט</p>
      <label className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#f06ba8] text-white text-xs font-semibold cursor-pointer hover:bg-[#7dab5a] transition-colors">
        <input type="file" accept=".xls,.xlsx" onChange={handleFileUpload} className="hidden" ref={fileRef} />
        {syncing ? "מסנכרן..." : "בחר קובץ"}
      </label>
      {result && <p className="text-xs mt-2 text-[#1a1a4b]">{result}</p>}
    </div>
  );
}
...
function OverviewModule() {
  ...
  if (loading) return <div className="flex justify-center py-16"><Loader2 className="w-6 h-6 animate-spin text-[#1a1a4b]" /></div>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon={<MessageSquare className="w-5 h-5" />} color="#1a1a4b" bg="#fce7f3" label="לידים ופניות" value={stats.leads} />
        ...
        <StatCard icon={<Mail className="w-5 h-5" />} color="#3b3f99" bg="#fee2e2" label="פניות צור קשר" value={stats.contacts} />
      </div>
...
function QuickActionCard({ icon, gradient, title, subtitle }: {
  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border hover:shadow-md transition-all cursor-pointer group">
      ...
      <h4 className="font-bold text-[#1a1a4b] mb-0.5">{title}</h4>
...
function BlogModule() {
  ...
  return (
    <div>
      ...
      {loading ? (
        <div className="flex justify-center py-16"><Loader2 className="w-6 h-6 animate-spin text-[#1a1a4b]" /></div>
      ) : filtered.length === 0 ? (
          ...
          {filtered.map((post) => (
            <div key={post.id} className="bg-white rounded-xl p-4 border shadow-sm flex items-center justify-between hover:shadow-md transition-shadow">
              <div className="min-w-0 flex-1">
                <h4 className="font-semibold text-[#1a1a4b] truncate">{post.title}</h4>
                <div className="flex items-center gap-3 mt-1 text-xs text-gray-400">
                  {post.category && <span className="bg-[#fce7f3] text-[#1a1a4b] px-2 py-0.5 rounded-full text-[10px] font-medium">{post.category}</span>}
    ...
    <div>
      ...
      <div className="flex gap-2 mb-6">
        <Button
          ...
          className={cn("rounded-full gap-2", tab === "leads" && "bg-[#1a1a4b] hover:bg-[#222159]")}
        ...
        <Button
          ...
          className={cn("rounded-full gap-2", tab === "contacts" && "bg-[#1a1a4b] hover:bg-[#222159]")}
          ...
          <div className="space-y-3">
            {leads.map((lead) => (
              <div key={lead.id} className="bg-white rounded-xl p-4 border shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-[#1a1a4b]">{lead.full_name}</h4>
                    <div className="flex items-center gap-3 mt-1 text-xs text-gray-400">
                      <span dir="ltr">{lead.phone}</span>
                      <span>{lead.email}</span>
                      <span className="bg-[#fce7f3] text-[#1a1a4b] px-2 py-0.5 rounded-full text-[10px] font-medium">{lead.insurance_type}</span>
                    </div>
                  </div>
          ...
          <div className="space-y-3">
            {contacts.map((c) => (
              <div key={c.id} className="bg-white rounded-xl p-4 border shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-[#1a1a4b]">{c.name}</h4>
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border mb-6">
        <h3 className="font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
          <Link2 className="w-5 h-5" />
          שלח לינק כניסה
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div>
            <Label className="text-xs font-medium text-[#1a1a4b]">שם הלקוח</Label>
            <Input
              value={name}
          ...
          <div>
            <Label className="text-xs font-medium text-[#1a1a4b]">טלפון</Label>
            <Input
              type="tel"
              value={phone}
          ...
          <div>
            <Label className="text-xs font-medium text-[#1a1a4b]">אימייל</Label>
            <Input
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            className="gap-2 rounded-full bg-[#1a1a4b] hover:bg-[#222159] shadow-lg shadow-[#1a1a4b]/15"
          >
      ...
      {sent.length > 0 && (
        <div className="bg-white rounded-2xl p-6 shadow-sm border">
          <h4 className="text-sm font-bold text-[#1a1a4b] mb-3">נשלחו היום ({sent.length})</h4>
          <div className="space-y-2">
            {sent.map((item, i) => (
              <div key={i} className="flex items-center gap-2 text-sm text-gray-600 bg-[#fce7f3]/50 rounded-lg px-3 py-2">
    ...
    <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <div>
            <Label className="text-xs font-medium text-[#1a1a4b]">אימייל הסוכן</Label>
            <Input
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
          ...
          <div>
            <Label className="text-xs font-medium text-[#1a1a4b]">טלפון הסוכן</Label>
            <Input
              type="tel"
              value={agentPhone}
      ...
      {agents.length > 0 && (
        <div className="bg-white rounded-2xl p-6 shadow-sm border mb-6">
          <h4 className="text-sm font-bold text-[#1a1a4b] mb-4 flex items-center gap-2">
          ...
          <div className="space-y-2">
            {agents.map((a) => (
              <div key={a.id} className="flex items-center justify-between px-4 py-3 rounded-xl bg-gray-50 border border-gray-100">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full flex items-center justify-center text-white text-sm font-bold" style={{ background: "linear-gradient(135deg, #1a1a4b, #222159)" }}>
                    {a.full_name?.charAt(0) || "?"}
                  </div>
                  <div>
                    <p className="font-medium text-sm text-[#1a1a4b]">{a.full_name}</p>
                    {a.phone && <p className="text-[11px] text-gray-400" dir="ltr">{a.phone}</p>}
                  </div>
                </div>
                <span className={cn(
                  "text-[10px] font-medium px-2.5 py-1 rounded-full",
                  a.role === "admin" ? "bg-[#fce7f3] text-[#1a1a4b]" : "bg-gray-100 text-gray-500"
                )}>
          ...
          {filtered.map(s => {
            ...
            return (
              <div key={s.id} className="bg-white rounded-xl p-4 border shadow-sm">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-[#fce7f3] flex items-center justify-center text-[#1a1a4b] font-bold text-sm">
                      {(s.first_name?.[0] || "?").toUpperCase()}
                    </div>
                    <div>
                      <h4 className="font-semibold text-[#1a1a4b]">{fullName}</h4>
            ...
            <tbody>
              {submissions.map(s => (
                <tr key={s.id} className="border-b hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 font-medium text-[#1a1a4b]">{[s.first_name, s.last_name].filter(Boolean).join(" ") || "—"}</td>
...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
      ...
      <span className="text-sm font-medium text-[#1a1a4b]" dir="ltr">{value}</span>
    </div>
  );
}
...
function LinkButton({ label, href }: { label: string; href: string }) {
  return (
    <a
      ...
      className="flex items-center gap-2 px-4 py-3 rounded-xl border border-gray-200 hover:border-[#1a1a4b]/30 hover:bg-[#fce7f3]/30 text-sm text-[#1a1a4b] font-medium transition-all"
    >
