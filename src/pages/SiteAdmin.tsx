...
export default function SiteAdmin() {
  const { user, loading: authLoading, signInWithOtp, verifyOtp, signOut } = useAuth();
              ...
              {step === "login" && (
                ...
                >
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium text-[#0a3d3d]">אימייל מנהל</Label>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-12 rounded-full gap-2 font-semibold bg-[#0a3d3d] hover:bg-[#0d4a4a] shadow-lg shadow-[#0a3d3d]/20"
                    disabled={loading}
                  >
