...
export default function TermsPage() {
  ...
  const content = (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-8 text-sm leading-relaxed text-gray-700">
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">1. כללי</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">2. הגדרות</h2>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">3. תנאי שימוש</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">4. הגבלת אחריות</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">5. שיפוי</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">6. קניין רוחני</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">7. פרטיות ואבטחת מידע</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">8. זמינות המערכת</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">9. סיום שימוש</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">10. שינויים בתנאי השימוש</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">11. דין חל וסמכות שיפוט</h2>
        <p>
      ...
      <section>
        <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">12. יצירת קשר</h2>
        <p>
          לכל שאלה או פנייה בנוגע לתנאי שימוש אלו, ניתן לפנות אלינו בדוא"ל:
          <a href="mailto:info@seeld-ins.co.il" className="text-[#d6157e] font-medium mr-1">info@seeld-ins.co.il</a>
        </p>
      </section>
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative bg-[#f8f9fc] overflow-hidden">
        <div className="absolute top-6 left-12 w-20 h-20 rounded-full bg-[#d6157e] opacity-10" />
        <div className="absolute bottom-4 right-20 w-12 h-12 rounded-full bg-[#3b3f99] opacity-10" />
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 relative z-10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-extrabold text-[#1a1a4b]">תנאי שימוש</h1>
