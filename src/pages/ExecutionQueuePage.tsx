    ...
    <div className="max-w-5xl mx-auto">
      ...
      {items.length > 0 && (
        ...
        >
          ...
          <div className="rounded-2xl p-3 md:p-4 bg-[#d6157e]/5 border border-[#d6157e]/10 transition-all">
            <div className="flex items-center gap-2 mb-1">
              <CheckCircle2 className="h-4 w-4 text-[#1a1a4b]" />
              <span className="text-xs font-semibold text-[#1a1a4b]">בטיפול</span>
            </div>
      ...
      <div className="space-y-2.5">
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              <Card className={`rounded-2xl border-border/50 hover:shadow-lg hover:shadow-[#1a1a4b]/5 transition-all duration-300 hover:-translate-y-0.5 group overflow-hidden ${
                  ...
                  <div className="flex items-stretch">
                    ...
                    <div className="flex items-start justify-between flex-1 p-3 md:p-4 gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                          <button
                            ...
                            className="font-bold text-sm hover:text-[#1a1a4b] transition-colors flex items-center gap-1.5"
                          >
                            <div className="w-6 h-6 rounded-lg bg-[#1a1a4b]/8 flex items-center justify-center text-[10px] font-bold text-[#1a1a4b] shrink-0">
                        ...
                        {item.nextStep && (
                          <div className="flex items-center gap-1.5 mt-2 text-xs">
                            <span className="font-medium text-[#1a1a4b]">צעד הבא:</span>
                      ...
                      <Button
                        ...
                        variant="ghost"
                        onClick={() => navigate(`/app/customers/${item.customerId}`)}
                        className="rounded-xl h-9 w-9 p-0 min-h-[36px] hover:bg-[#d6157e]/10 shrink-0"
                      >
      ...
      {items.length === 0 && (
        ...
        >
          <div className="w-20 h-20 rounded-full bg-[#d6157e]/10 flex items-center justify-center mx-auto mb-5">
            <Zap className="h-10 w-10 text-[#d6157e]/50" />
          </div>
