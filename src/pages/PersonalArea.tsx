...
const PersonalArea = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc]" dir="rtl">
      ...
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(165deg, #072e2e 0%, #1a1a4b 40%, #222159 100%)" }}>
        ...
        {/* Small floating dots */}
        <div className="absolute top-6 left-[25%] w-2.5 h-2.5 rounded-full bg-[#d6157e] opacity-20 hidden sm:block" />
        <div className="absolute bottom-8 right-[35%] w-2 h-2 rounded-full bg-[#6b6fc4] opacity-25 hidden sm:block" />
        <div className="absolute top-[50%] left-[8%] w-3 h-3 rounded-full bg-[#f06ba8] opacity-15 hidden sm:block" />

        {/* Dashed curves */}
        <svg className="absolute bottom-0 left-0 w-full h-10 opacity-[0.06] pointer-events-none" viewBox="0 0 800 30" fill="none">
          <path d="M0 20 Q200 5 400 18 T800 8" stroke="#d6157e" strokeWidth="1" strokeDasharray="8 6" />
        </svg>
