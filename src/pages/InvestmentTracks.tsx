...
import { BONE, PINE, BRONZE, SERIF, MONO, CARD_SHADOW } from "@/lib/brand";
...
const PIE_STROKE = BONE; // slice separator = canvas white
    ...
    <div className="min-h-screen" dir="rtl" style={{ backgroundColor: BONE }}>
      ...
      <section style={{ backgroundColor: BONE }}>
        <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-12 sm:pt-16 pb-10 sm:pb-14">
          ...
          {/* Numbers band */}
          <div className="grid grid-cols-3 border-t border-b border-[#171717]/15 py-8">
            {heroStats.map((stat) => (
      ...
      <main className="bg-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12 sm:py-16 space-y-16 sm:space-y-20">
          {/* Personal track checker */}
          <ScrollReveal>
          ...
          <section>
            ...
            {/* Table — ruled rows, no card chrome */}
                    ...
                    return (
                      <Fragment key={fund.id}>
                        <tr
                          ...
                          className={`border-b cursor-pointer transition-colors ${isExpanded ? "border-[#171717]/40 bg-[#fafafa]" : "border-[#171717]/10 hover:bg-[#fafafa]"}`}
                        >
                        ...
                        {isExpanded && (
                          <tr>
                            <td colSpan={8} className="px-4 py-6 bg-[#fafafa] border-b border-[#171717]/15">
