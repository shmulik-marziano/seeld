...
function PersonalTrackChecker({ trackData }: { trackData: Fund[] }) {
  ...
  const getPieData = (fund: Fund) => [
    { name: "מניות", value: fund.deepDrill.stocksAndOptions, color: "#171717" },
    { name: 'אג"ח ממשלתי', value: fund.deepDrill.govBondsTradable + fund.deepDrill.designatedBonds, color: "#15803d" },
    { name: 'אג"ח קונצרני', value: fund.deepDrill.corpBondsTradable + fund.deepDrill.corpBondsNonTradable, color: "#b45309" },
    { name: "מזומן", value: fund.deepDrill.cashEquivalents + fund.deepDrill.deposits, color: "#94a3b8" },
    { name: "אחר", value: fund.deepDrill.mutualFunds + fund.deepDrill.otherAssets, color: "#171717" },
  ].filter(d => d.value > 0);
    ...
    <section className="mb-12">
      <div className="bg-white rounded-2xl border border-gray-100 p-6 sm:p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-extrabold text-[#171717]">בדקו את המסלול שלכם</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm bg-white text-[#171717]"
            >
        ...
        {selectedFund && (() => {
          ...
          return (
            <div className="bg-[#fafafa] rounded-2xl p-5 sm:p-6 border border-gray-100 space-y-6">
              {/* Fund header */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  <h3 className="text-lg font-bold text-[#171717]">{selectedFund.name}</h3>
                ...
                <div className="flex gap-3">
                  <div className="bg-white rounded-xl px-4 py-2 border border-gray-100 text-center">
                    ...
                    <p className="text-xl font-extrabold text-[#171717]">{fmt(selectedFund.returns.year1)}</p>
                  </div>
                  <div className="bg-white rounded-xl px-4 py-2 border border-gray-100 text-center">
                ...
                <div className="flex-1 space-y-2.5 w-full">
                  {pieData.map((d, idx) => (
                    <div key={idx} className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-bold text-[#171717]">{d.value.toFixed(1)}%</span>
                    </div>
                  ))}
                  <div className="border-t border-gray-100 pt-2 mt-2 space-y-1">
                    {selectedFund.deepDrill.foreignExposure > 0 && (
                      <div className="flex justify-between text-xs text-gray-400">
                        ...
                        <span className="font-semibold text-[#171717]">{selectedFund.deepDrill.foreignExposure}%</span>
                      </div>
                    )}
                    <div className="flex justify-between text-xs text-gray-400">
                      <span>דמ"נ מצבירה</span>
                      <span className="font-semibold text-[#171717]">{selectedFund.fees.savingsFeePercent}%</span>
                    </div>
                    <div className="flex justify-between text-xs text-gray-400">
                      <span>היקף נכסים</span>
                      <span className="font-semibold text-[#171717]">{fmtAssets(selectedFund.totalAssets)}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl p-4 border-r-4" style={{ borderColor: risk.color, background: risk.color + "08" }}>
                ...
                <Link to="/contact" className="inline-flex items-center gap-1 mt-2 text-sm font-bold text-[#171717] hover:underline">
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="bg-[#fafafa] relative overflow-hidden">
        <div className="absolute top-[10%] left-[4%] w-[90px] h-[90px] rounded-full bg-[#171717] opacity-[0.05]" />
        <div className="absolute bottom-[15%] right-[6%] w-[65px] h-[65px] rounded-full bg-[#171717] opacity-[0.05]" />
        <div className="absolute top-[45%] left-[18%] w-[35px] h-[35px] rounded-full bg-[#171717] opacity-[0.05]" />
        <div className="absolute top-[20%] right-[12%] w-[28px] h-[28px] rounded-full bg-[#171717] opacity-[0.05]" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#171717] mb-4 leading-tight">
            מסלולי <span className="text-[#171717]">השקעה</span>
          </h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white rounded-2xl p-4 border border-gray-100 text-center">
              <p className="text-3xl font-extrabold text-[#171717]">{trackData.length}</p>
              <p className="text-xs text-gray-400 mt-1">מסלולים במאגר</p>
            </div>
            <div className="bg-white rounded-2xl p-4 border border-gray-100 text-center">
              <p className="text-3xl font-extrabold text-[#171717]">{new Set(trackData.map(f => f.company)).size}</p>
              <p className="text-xs text-gray-400 mt-1">חברות</p>
            </div>
            <div className="bg-white rounded-2xl p-4 border border-gray-100 text-center">
              <p className="text-3xl font-extrabold text-[#171717]">{productTypes.length}</p>
              <p className="text-xs text-gray-400 mt-1">סוגי מוצרים</p>
            </div>
            <div className="bg-white rounded-2xl p-4 border border-gray-100 text-center">
              <p className="text-3xl font-extrabold text-[#171717]">2026</p>
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-[#171717] font-medium">מסלולי השקעה</span>
        </nav>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="space-y-4 mb-8">
          <div className="flex gap-3">
            ...
            >
              ...
              {(productFilter !== "all" || specFilter !== "all" || companyFilter !== "all") && (
                <span className="w-5 h-5 rounded-full bg-[#171717] text-white text-[10px] flex items-center justify-center">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-semibold shrink-0 transition-all ${productFilter === "all" ? "bg-[#171717] text-white" : "bg-[#fafafa] text-gray-500 hover:bg-gray-100"}`}
            >
            ...
            {productTypes.map(pt => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold shrink-0 transition-all ${productFilter === pt ? "bg-[#171717] text-white" : "bg-[#fafafa] text-gray-500 hover:bg-gray-100"}`}
              >
          ...
          {/* Expanded filters */}
          {showFilters && (
            <div className="bg-[#fafafa] rounded-2xl p-5 space-y-4 border border-gray-100">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-bold text-[#171717]">סינון מתקדם</h3>
                <button onClick={() => { setProductFilter("all"); setSpecFilter("all"); setCompanyFilter("all"); setSearch(""); }} className="text-xs text-[#171717] font-semibold">
                  נקה הכל
                </button>
              </div>
        ...
        <div className="flex items-center justify-between mb-4 text-sm">
          <span className="text-gray-500">{filtered.length} מסלולים | {uniqueCompanies} חברות | ממוצע תשואה 12 חודשים: <strong className="text-[#171717]">{fmt(avgReturn)}</strong></span>
          {bestFund && (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#fafafa] border-b border-gray-100">
                  <th className="text-right px-4 py-3 font-bold text-[#171717] min-w-[200px]">
                    <button onClick={() => toggleSort("name")} className="flex items-center gap-1">
                      שם מסלול
                      <ArrowUpDown className="w-3 h-3 text-gray-400" />
                    </button>
                  </th>
                  <th className="text-center px-3 py-3 font-bold text-[#171717]">חברה</th>
                  <th className="text-center px-3 py-3 font-bold text-[#171717]">קטגוריה</th>
                  <th className="text-center px-3 py-3 font-bold text-[#171717]">
                    <button onClick={() => toggleSort("year1")} className="flex items-center gap-1 mx-auto">
                      12 חודשים
                      <ArrowUpDown className="w-3 h-3 text-gray-400" />
                    </button>
                  </th>
                  <th className="text-center px-3 py-3 font-bold text-[#171717] hidden sm:table-cell">
                    <button onClick={() => toggleSort("year3")} className="flex items-center gap-1 mx-auto">
                      3 שנים
                      <ArrowUpDown className="w-3 h-3 text-gray-400" />
                    </button>
                  </th>
                  <th className="text-center px-3 py-3 font-bold text-[#171717] hidden md:table-cell">
                    <button onClick={() => toggleSort("year5")} className="flex items-center gap-1 mx-auto">
                      5 שנים
                      <ArrowUpDown className="w-3 h-3 text-gray-400" />
                    </button>
                  </th>
                  <th className="text-center px-3 py-3 font-bold text-[#171717] hidden lg:table-cell">
              ...
              <tbody>
                {filtered.map((fund, i) => {
                  ...
                  const returnColor = (v: number) => v > avgReturn ? "text-[#15803d]" : v < 0 ? "text-[#b91c1c]" : "text-[#171717]";
                  return (
                    <>
                      <tr
                        key={fund.id}
                        onClick={() => setExpandedId(isExpanded ? null : fund.id)}
                        className={`border-b border-gray-50 cursor-pointer transition-colors ${isExpanded ? "bg-[#fafafa]" : "hover:bg-[#fafbfd]"} ${i === 0 && sortKey === "year1" ? "bg-[#15803d]/5" : ""}`}
                      >
                        <td className="px-4 py-3">
                          <div className="font-semibold text-[#171717] text-sm">{fund.name}</div>
                        ...
                        <td className="text-center px-3 py-3">
                          <span className="text-xs px-2 py-0.5 rounded-full bg-[#fafafa] border border-gray-100 text-[#171717]">
                      ...
                      {isExpanded && (
                        <tr key={fund.id + "-detail"}>
                          <td colSpan={8} className="px-4 py-5 bg-[#fafafa] border-b border-gray-100">
                            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                              <div className="bg-white rounded-xl p-3 border border-gray-100 text-center">
                                <p className="text-xs text-gray-400 mb-1">תשואת חודש</p>
                                <p className="text-lg font-bold text-[#171717]">{fmt(fund.returns.month)}</p>
                              </div>
                              <div className="bg-white rounded-xl p-3 border border-gray-100 text-center">
                                <p className="text-xs text-gray-400 mb-1">חשיפת מניות</p>
                                <p className="text-lg font-bold text-[#171717]">{fund.stockExposure}%</p>
                              </div>
                              <div className="bg-white rounded-xl p-3 border border-gray-100 text-center">
                                <p className="text-xs text-gray-400 mb-1">דמ"נ מהפקדה</p>
                                <p className="text-lg font-bold text-[#171717]">{fund.fees.depositFeePercent}%</p>
                              </div>
                              <div className="bg-white rounded-xl p-3 border border-gray-100 text-center">
                                <p className="text-xs text-gray-400 mb-1">היקף נכסים</p>
                                <p className="text-lg font-bold text-[#171717]">{fmtAssets(fund.totalAssets)}</p>
                              </div>
                              {fund.deepDrill.sharpeRatio && (
                                <div className="bg-white rounded-xl p-3 border border-gray-100 text-center">
                                  <p className="text-xs text-gray-400 mb-1">מדד שארפ</p>
                                  <p className="text-lg font-bold text-[#171717]">{fund.deepDrill.sharpeRatio.toFixed(2)}</p>
                                </div>
                              )}
                            </div>
                            ...
                            {(() => {
                              ...
                              const pieData = [
                                { name: "מניות", value: dd.stocksAndOptions, color: "#171717" },
                                { name: 'אג"ח ממשלתי', value: dd.govBondsTradable + dd.designatedBonds, color: "#15803d" },
                                { name: 'אג"ח קונצרני', value: dd.corpBondsTradable + dd.corpBondsNonTradable, color: "#b45309" },
                                { name: "מזומן", value: dd.cashEquivalents + dd.deposits, color: "#94a3b8" },
                                { name: "קרנות נאמנות", value: dd.mutualFunds, color: "#171717" },
                                { name: "אחר", value: dd.otherAssets, color: "#b91c1c" },
                              ].filter(d => d.value > 0);
                              return (
                                <div className="mt-4 bg-white rounded-xl p-4 border border-gray-100">
                                  <h4 className="text-sm font-bold text-[#171717] mb-3">הרכב נכסים — חשיפות</h4>
                                    ...
                                    <div className="flex-1 space-y-2">
                                      ...
                                      {dd.foreignExposure > 0 && (
                                        <div className="flex items-center justify-between text-sm pt-1">
                                          ...
                                          <span className="font-semibold text-[#171717]">{dd.foreignExposure}%</span>
                                        </div>
                                      )}
                                      {dd.currencyExposure > 0 && (
                                        <div className="flex items-center justify-between text-sm">
                                          <span className="text-gray-400">חשיפת מט"ח</span>
                                          <span className="font-semibold text-[#171717]">{dd.currencyExposure}%</span>
                                        </div>
                                      )}
                                    </div>
                                  </div>
                            ...
                            <div className="mt-3 text-center">
                              <Link to="/contact" className="text-sm text-[#171717] font-semibold hover:underline">
        ...
        <section className="mt-16 space-y-10">
          <div className="max-w-3xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#171717] mb-6">מה זה מסלול השקעה?</h2>
          ...
          <div className="max-w-3xl">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#171717] mb-6">איך לבחור מסלול השקעה?</h2>
            <div className="space-y-4 text-gray-600 leading-relaxed text-base">
              <p>
        ...
        {/* Disclaimer */}
        <section className="mt-12 rounded-2xl bg-[#fafafa] p-6 sm:p-8 border border-gray-100">
        ...
        <section className="mt-12">
          <div className="bg-[#fafafa] rounded-2xl p-8 sm:p-12 text-center relative overflow-hidden">
            <div className="absolute top-4 right-6 w-20 h-20 rounded-full bg-[#171717] opacity-[0.05]" />
            <div className="absolute bottom-4 left-10 w-14 h-14 rounded-full bg-[#171717] opacity-[0.05]" />
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#171717] mb-3 relative z-10">
            ...
            <Link
              to="/contact"
              className="inline-block px-8 py-3.5 bg-[#171717] text-white font-semibold rounded-full hover:bg-[#262626] transition-colors relative z-10"
            >
              קבלו ניתוח תיק חינם
            </Link>
          </div>
