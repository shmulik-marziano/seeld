  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        <div className="absolute top-6 left-8 w-24 h-24 rounded-full bg-[#f06ba8] opacity-12" />
        <div className="absolute bottom-8 right-14 w-16 h-16 rounded-full bg-[#d6157e] opacity-15" />
        ...
        <svg className="absolute top-12 left-1/4 w-64 h-32 opacity-10" viewBox="0 0 200 80" fill="none">
          <path d="M10 70 Q60 10 100 40 T190 20" stroke="#d6157e" strokeWidth="2" strokeDasharray="6 4" />
        </svg>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 leading-tight text-[#1a1a4b]">
            שירותים <span className="text-[#3b3f99]">ופעולות</span>
          </h1>
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-[#1a1a4b] font-medium">שירותים ופעולות</span>
        </nav>
      </div>
      ...
      <main>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1a1a4b] mb-8">השירותים שלנו</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.map((service, idx) => (
                <div key={idx} className="bg-white border border-[#1a1a4b]/[0.06] rounded-2xl p-6 hover:shadow-lg transition-all text-center">
                  ...
                  <h3 className="text-lg font-bold text-[#1a1a4b] mb-2">{service.title}</h3>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1a1a4b] mb-6">למה SEELD?</h2>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="bg-[#1a1a4b] rounded-3xl p-8 sm:p-12 text-center relative overflow-hidden">
              ...
              <div className="absolute top-10 right-1/4 w-8 h-8 rounded-full bg-[#f06ba8] opacity-10" />
