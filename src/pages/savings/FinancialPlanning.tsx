    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1a1a4b] mb-4 leading-tight">
            המרכז <span className="text-[#d6157e]">לתכנון כלכלי</span> מתקדם
          </h1>
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <ChevronLeft className="w-3.5 h-3.5" />
          <span className="text-[#1a1a4b] font-medium">תכנון כלכלי מתקדם</span>
        </nav>
      </div>
      ...
      <main>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-8">למה תכנון כלכלי?</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: PieChart, doodle: "charts", title: "ניתוח מקיף", desc: "מיפוי מלא של המצב הכלכלי", color: "#d6157e" },
                { icon: Target, doodle: "target", title: "יעדים ברורים", desc: "הגדרת יעדים מדידים וריאליים", color: "#6b6fc4" },
                { icon: TrendingUp, doodle: "growth", title: "מקסום הון", desc: "אסטרטגיה להגדלת ההון שלכם", color: "#f06ba8" },
                { icon: Lightbulb, doodle: "lightbulb", title: "ליווי שוטף", desc: "מעקב ועדכון לאורך כל הדרך", color: "#3b3f99" },
              ].map((item, idx) => (
        ...
        <section id="product-types" className="py-10 sm:py-16 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-2">שלבי התכנון הכלכלי</h2>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mt-14 mb-6">מתי כדאי להתחיל?</h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-base sm:text-lg">
                <p>
        ...
        <section id="analysis-form" className="py-10 sm:py-16 scroll-mt-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="bg-[#f8f9fc] border border-[#1a1a4b]/[0.06] rounded-2xl p-8 sm:p-12 text-center mb-10 relative overflow-hidden">
              <div className="absolute top-4 left-6 w-10 h-10 rounded-full bg-[#d6157e] opacity-15" />
              <div className="absolute bottom-4 right-8 w-8 h-8 rounded-full bg-[#6b6fc4] opacity-15" />
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-3 text-[#1a1a4b]">מוכנים לתכנון כלכלי מקצועי?</h2>
