    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1a1a4b] mb-4 leading-tight">
            ניהול <span className="text-[#f06ba8]">חכם של הפנסיה</span>
          </h1>
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <ChevronLeft className="w-3.5 h-3.5" />
          <span className="text-[#1a1a4b] font-medium">אחרי פרישה</span>
        </nav>
      </div>
      ...
      <main>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-8">מה כולל ליווי אחרי פרישה?</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Banknote, doodle: "savings", title: "אופטימיזציית קצבה", desc: "מקסום הקצבה החודשית שלכם", color: "#d6157e" },
                { icon: HeartHandshake, doodle: "family", title: "מיצוי זכויות", desc: "ניצול כל ההטבות והזכויות", color: "#6b6fc4" },
                { icon: Umbrella, doodle: "umbrella", title: "הגנה על הון", desc: "שמירה על ערך החסכונות", color: "#f06ba8" },
                { icon: Shield, doodle: "shield", title: "ביטוח מתאים", desc: "כיסוי רפואי וסיעודי מותאם", color: "#3b3f99" },
              ].map((item, idx) => (
        ...
        <section id="product-types" className="py-10 sm:py-16 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-2">שירותים לפנסיונרים</h2>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mt-14 mb-6">מתי כדאי לפנות?</h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-base sm:text-lg">
                <p>
        ...
        <section id="analysis-form" className="py-10 sm:py-16 scroll-mt-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="bg-[#f8f9fc] border border-[#1a1a4b]/[0.06] rounded-2xl p-8 sm:p-12 text-center mb-10 relative overflow-hidden">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-3 text-[#1a1a4b]">כבר בפנסיה? בואו נוודא שאתם ממצים הכל</h2>
