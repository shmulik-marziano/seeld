...
const PensionFunds = () => {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      {/* Hero Banner — light style with colored circles */}
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1a1a4b] mb-4 leading-tight">
            קרנות <span className="text-[#f06ba8]">פנסיה</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-8">
            ...
            <a href="#pension-types" className="inline-flex items-center justify-center px-8 py-3.5 rounded-full border border-[#1a1a4b]/15 text-[#1a1a4b] font-semibold text-base hover:bg-[#1a1a4b]/5 transition-all min-h-[48px]">
              סוגי פנסיה
            </a>
          </div>
        </div>
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <ChevronLeft className="w-3.5 h-3.5" />
          <span className="text-[#1a1a4b] font-medium">קרנות פנסיה</span>
        </nav>
      </div>
      ...
      <main>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-8">יתרונות קרן הפנסיה</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: TrendingUp, doodle: "growth", title: "תשואות מנוהלות", desc: "הכספים מנוהלים על ידי מנהלי השקעות מקצועיים", color: "#d6157e" },
                { icon: Shield, doodle: "shield", title: "כיסויים ביטוחיים", desc: "פנסיית נכות ושאירים להגנה על המשפחה", color: "#6b6fc4" },
                { icon: Calculator, doodle: "calculator", title: "הטבות מס", desc: "זיכוי מס והפחתת הכנסה חייבת במס", color: "#f06ba8" },
                { icon: Users, doodle: "handshake", title: "ליווי מקצועי", desc: "צוות יועצים מנוסה לבחירת המסלול המתאים", color: "#3b3f99" },
              ].map((item, idx) => (
        ...
        <section id="pension-types" className="py-10 sm:py-16 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-2">סוגי קרנות פנסיה</h2>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-6">למה קרן פנסיה חשובה?</h2>
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mt-14 mb-6">מתי כדאי לבדוק את קרן הפנסיה?</h2>
              <div className="space-y-4 text-gray-600 leading-relaxed text-base sm:text-lg">
                <p>
        ...
        <section id="analysis-form" className="py-10 sm:py-16 scroll-mt-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="bg-[#f8f9fc] border border-[#1a1a4b]/[0.06] rounded-2xl p-8 sm:p-12 text-center mb-10 relative overflow-hidden">
              <div className="absolute top-4 left-6 w-10 h-10 rounded-full bg-[#f06ba8] opacity-15" />
              <div className="absolute bottom-4 right-8 w-8 h-8 rounded-full bg-[#d6157e] opacity-15" />
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-3 text-[#1a1a4b]">רוצים ניתוח פנסיוני חינמי?</h2>
