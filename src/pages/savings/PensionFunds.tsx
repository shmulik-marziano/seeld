...
import { PiggyBank, TrendingUp, Shield, Users, Calculator } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    <div className="min-h-screen" dir="rtl" style={{ backgroundColor: BONE }}>
        ...
        <div className="max-w-5xl mx-auto px-5 sm:px-8 pt-12 sm:pt-16 pb-12 sm:pb-16">
          ...
          <div className="border-t border-[#1a1a18]/20 pt-5 mb-10 sm:mb-14 flex items-baseline justify-between gap-4">
            <nav className="flex items-center gap-2 text-[12px] text-[#1a1a18]/40">
              ...
              <span>←</span>
              <span className="text-[#1a1a18]/70 font-medium">קרנות פנסיה</span>
            </nav>
          </div>
      ...
      <main>
        ...
        {/* ══════ PENSION TYPES ══════ */}
        <section id="pension-types" style={{ backgroundColor: BONE }}>
          <div className="max-w-5xl mx-auto px-5 sm:px-8 py-12 sm:py-16">
            <div className="border-t border-[#1a1a18]/20 pt-5 mb-10">
              <h2
                className="text-[#1a1a18] leading-tight"
              ...
              <p className="text-[#1a1a18]/45 mt-2 text-[15px] leading-relaxed max-w-xl">הכירו את האפשרויות השונות ובחרו את המסלול המתאים לכם</p>
            </div>
