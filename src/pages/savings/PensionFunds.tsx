      ...
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#0a3d3d] mb-4 leading-tight">
            קרנות <span className="text-[#90be6d]">פנסיה</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-8">
            ...
            <a href="#pension-types" className="inline-flex items-center justify-center px-8 py-3.5 rounded-full border border-[#0a3d3d]/15 text-[#0a3d3d] font-semibold text-base hover:bg-[#0a3d3d]/5 transition-all min-h-[48px]">
              סוגי פנסיה
            </a>
          </div>
        </div>
