  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        <div className="absolute top-[10%] left-[4%] w-[90px] h-[90px] rounded-full bg-[#3b3f99]" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-28 relative">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1a1a4b] mb-4 leading-tight">
            בנו את <span className="text-[#3b3f99]">העתיד הפיננסי</span> שלכם
          </h1>
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <ChevronLeft className="w-3.5 h-3.5" />
          <span className="text-[#1a1a4b] font-medium">חיסכון והשקעה</span>
        </nav>
      </div>
      ...
      <main>
        ...
        <section className="py-10 sm:py-16">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-8">פתרונות ההשקעה שלנו</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: Target, doodle: "target", title: "התאמה אישית", desc: "תיק השקעות מותאם לפרופיל שלכם", color: "#d6157e" },
                { icon: TrendingUp, doodle: "growth", title: "ניהול מקצועי", desc: "צוות מנהלי השקעות מנוסים", color: "#6b6fc4" },
                { icon: Coins, doodle: "savings", title: "פיזור סיכונים", desc: "אסטרטגיה חכמה להקטנת סיכון", color: "#f06ba8" },
                { icon: BarChart3, doodle: "charts", title: "מגוון אפיקים", desc: "גישה למניות, אג\"ח, נדל\"ן ועוד", color: "#3b3f99" },
              ].map((item, idx) => (
        ...
        <section id="product-types" className="py-10 sm:py-16 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#1a1a4b] mb-2">סוגי פתרונות השקעה</h2>
        ...
        <section id="analysis-form" className="py-10 sm:py-16 scroll-mt-24">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="bg-[#f8f9fc] border border-[#1a1a4b]/[0.06] rounded-2xl p-8 sm:p-12 text-center mb-10 relative overflow-hidden">
              <div className="absolute top-4 left-6 w-10 h-10 rounded-full bg-[#3b3f99] opacity-15" />
              <div className="absolute bottom-4 right-8 w-8 h-8 rounded-full bg-[#d6157e] opacity-15" />
              <h2 className="text-2xl sm:text-3xl font-extrabold mb-3 text-[#1a1a4b]">רוצים ייעוץ השקעות מקצועי?</h2>
