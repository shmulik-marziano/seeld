    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative bg-[#f8f9fc] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 relative z-10">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[#6b6fc4] flex items-center justify-center">
              <Cookie className="h-5 w-5 text-white" />
            </div>
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-[#1a1a4b]">מדיניות עוגיות (Cookies)</h1>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="space-y-8 text-sm leading-relaxed text-gray-700">
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">מה הן עוגיות?</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">סוגי העוגיות שאנו משתמשים בהן</h2>

            <div className="space-y-5 mt-4">
              <div className="bg-[#f8f9fc] rounded-xl p-5">
                <h3 className="text-base font-bold text-[#1a1a4b] mb-2">עוגיות הכרחיות</h3>
                <p>
              ...
              <div className="bg-[#f8f9fc] rounded-xl p-5">
                <h3 className="text-base font-bold text-[#1a1a4b] mb-2">עוגיות פונקציונליות</h3>
                <p>
              ...
              <div className="bg-[#f8f9fc] rounded-xl p-5">
                <h3 className="text-base font-bold text-[#1a1a4b] mb-2">עוגיות אנליטיות</h3>
                <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">ניהול עוגיות</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">עוגיות צד שלישי</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#1a1a4b] mb-3">יצירת קשר</h2>
            <div className="bg-[#f8f9fc] rounded-xl p-5">
              <p>לשאלות בנוגע למדיניות העוגיות, ניתן לפנות אלינו:</p>
              <p className="mt-2">אימייל: <a href="mailto:info@seeld-ins.co.il" className="text-[#d6157e] hover:underline">info@seeld-ins.co.il</a></p>
              <p>טלפון: <a href="tel:0523097444" className="text-[#d6157e] hover:underline">052-309-7444</a></p>
            </div>
          </section>
        </div>
      </main>
