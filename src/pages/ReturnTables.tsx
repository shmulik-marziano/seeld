  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="bg-[#f8f9fc] relative overflow-hidden">
        <div className="absolute top-[10%] right-[5%] w-[85px] h-[85px] rounded-full bg-[#f06ba8]" />
        <div className="absolute bottom-[12%] left-[7%] w-[60px] h-[60px] rounded-full bg-[#d6157e]" />
        <div className="absolute top-[50%] right-[20%] w-[30px] h-[30px] rounded-full bg-[#6b6fc4]" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 relative z-10 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1a1a4b] mb-4 leading-tight">
            לוחות <span className="text-[#f06ba8]">תשואה</span>
          </h1>
          ...
          <div className="mt-5">
            <Link to="/fund-finder">
              <Button variant="outline" className="border-[#1a1a4b] text-[#1a1a4b] rounded-full px-6 text-sm font-semibold">
      ...
      <div className="border-b border-gray-100">
        <nav className="max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-[#1a1a4b] font-medium">לוחות תשואה</span>
        </nav>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-2xl bg-white border border-gray-100 p-6 text-center">
            <div className="w-14 h-14 rounded-full bg-[#f06ba8] flex items-center justify-center mx-auto mb-3">
              <TrendingUp className="w-6 h-6 text-white" />
            </div>
            <p className="text-3xl font-extrabold text-[#1a1a4b]">{maxYear.toFixed(2)}%</p>
            <p className="text-sm text-gray-500 mt-1">תשואה שנתית מקסימלית</p>
            <p className="text-xs text-gray-400 mt-1">{topFund?.name}</p>
          </div>
          <div className="rounded-2xl bg-white border border-gray-100 p-6 text-center">
            <div className="w-14 h-14 rounded-full bg-[#d6157e] flex items-center justify-center mx-auto mb-3">
              <Calendar className="w-6 h-6 text-white" />
            </div>
            <p className="text-3xl font-extrabold text-[#1a1a4b]">{maxFiveYear.toFixed(2)}%</p>
          ...
          <div className="rounded-2xl bg-white border border-gray-100 p-6 text-center">
            ...
            <p className="text-3xl font-extrabold text-[#1a1a4b]">{totalFunds}</p>
