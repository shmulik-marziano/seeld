...
import { BONE, PINE, BRONZE, SERIF, MONO, CARD_SHADOW, RING } from '@/lib/brand';
      ...
      <main className="bg-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 sm:py-14">
          <div className="flex flex-col lg:flex-row gap-10">
            {/* Search panel — the one genuine data card on the page */}
            <aside className="lg:w-80 flex-shrink-0">
              <div className="sticky top-4 rounded-lg bg-white p-6" style={{ boxShadow: CARD_SHADOW }}>
                <div className="border-b border-[#171717]/10 pb-4 mb-5">
                  ...
                  <div>
                    {search.results
                      ...
                      .map((fund) => (
                        <div
                          key={fund.id}
                          className="flex items-center justify-between gap-4 py-3 border-b border-[#171717]/10 hover:border-[#171717]/40 transition-colors"
                        >
          ...
          {/* Disclaimer */}
          <div className="mt-16 border-t border-[#171717]/15 pt-6 max-w-3xl">
