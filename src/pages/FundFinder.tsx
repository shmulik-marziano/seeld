  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative bg-[#fafafa] overflow-hidden">
        <div className="absolute top-8 right-10 w-20 h-20 rounded-full bg-[#171717] opacity-[0.05]" />
        <div className="absolute bottom-6 left-16 w-16 h-16 rounded-full bg-[#171717] opacity-[0.05]" />
        <div className="absolute top-1/2 right-1/3 w-10 h-10 rounded-full bg-[#171717] opacity-[0.05]" />
        <svg className="absolute bottom-0 left-0 w-full h-20 opacity-10 pointer-events-none" viewBox="0 0 800 80" fill="none">
          <path d="M0 60 Q200 15 400 45 T800 25" stroke="#171717" strokeWidth="2" strokeDasharray="8 6" />
          <polygon points="795,23 800,25 795,27" fill="#171717" />
        </svg>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            ...
            {search.selectedFunds.length === 0 && (
              <div className="rounded-2xl bg-gradient-to-br from-[#fafafa] to-white border border-gray-100 p-12 text-center">
                <div className="w-20 h-20 rounded-full bg-[#171717]/5 flex items-center justify-center mx-auto mb-4">
                  <SearchIcon className="w-10 h-10 text-[#171717]" />
                </div>
            ...
            {search.results.length > 0 && search.mode !== 'top' && (
              <div className="space-y-3">
                <h3 className="text-sm font-semibold text-[#171717]">תוצאות חיפוש</h3>
