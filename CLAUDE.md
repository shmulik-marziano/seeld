> **SEELD project lock:** before any UI work, read `STYLESEED.md` at the repo root.
> It locks the skin (SEELD Mono / Vercel-derived), the Flim wordmark hero signature,
> fonts (Heebo + Geist Mono), Snap motion, radius, shadows and the greyscale ramp.
> STYLESEED.md overrides any conflicting generic guidance below.
