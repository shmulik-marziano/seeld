...
**מובייל, רמת גימור והיררכיית מוצרים בענף `feature/mobile-craft`** (מעל לוח התשואות, ממתין לאישור): סדר המוצרים לכל האתר ב-`src/data/productDirectory.ts` (פיננסים, חיים ובריאות, כללי). כפתורים צפים קומפקטיים בטלפון, תיקון גלישה ועימוד במסלולי השקעה, כרטיסי שירות קומפקטיים בבית, טקסט 14 פיקסל מינימום, יעדי מגע 44, איורי קיט במקום תמונות סטוק בבלוג, `api/geo.ts` במקום שירות מיקום חיצוני. כלי סקר: `scripts/mobile_audit.mjs`. דוח + תוכנית "צוות עיצוב": `docs/history/2026-09-17-mobile-and-craft.md`.
